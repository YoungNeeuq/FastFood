    ...
    <body>
        ...
        <div style="margin:90px 0 130px">
            <div style=" text-align: center; margin-bottom: 30px;">
                <h1 style="font-weight: bold;">Đơn hàng đang chờ vận chuyển</h1>
            ...
            <%
                List<Order> waitingList = (List) request.getAttribute("waitingList");
            ...
            <table class="table" style="text-align: center;">
                ...
                <tbody>
                    <c:forEach var="order" items="<%= waitingList%>">
                        <tr>
                            ...
                            <td>
                                <form action="WaitingOrderServlet" method="POST">
